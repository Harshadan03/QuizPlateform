    ...
    return (
        <div className="dashboard">
            ...
            <div>
                ...
                <hr></hr>
                <p>1. Following quiz provides Multiple Choice Questions (MCQs) related to Javascript Framework. </p>
                ...
                <p>6. The test contains 6 questions and there is  time limit of 3 minutes.</p>
